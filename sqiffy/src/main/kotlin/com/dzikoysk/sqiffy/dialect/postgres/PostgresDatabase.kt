...
interface PostgresDslHandle : DslHandle<PostgresDatabase> {

    override fun select(table: Table): SelectStatement =
        SelectStatement(
...
class PostgresDatabase(state: SqiffyDatabaseConfig) : PostgresDslHandle, SqiffyDatabase<PostgresDatabase>(state) {

    override fun select(table: Table): SelectStatement =
        super<PostgresDslHandle>.select(table)
